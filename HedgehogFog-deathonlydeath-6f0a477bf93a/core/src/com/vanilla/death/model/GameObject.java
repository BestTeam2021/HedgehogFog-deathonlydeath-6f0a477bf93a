...
//    }
    ...
    public boolean update(Vector2 next_position, float delta){
        ...
        updateLookDir(next_position);
        bounds.setPosition(position);

        return atPoint;
    }

    private void updateLookDir(Vector2 next_postion){
    ...
    public void setScript(GameScript gameScript){ this.gameScript = gameScript; }
    public boolean hasScript(){ return gameScript!=null; }
    public void runScript(){ gameScript.run(); gameScript = null; }
